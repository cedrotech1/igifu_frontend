        ...
        <div className="container position-relative">
          <div className="row gy-5" data-aos="fade-in">
            ...
            <div className="col-lg-6 order-1 order-lg-2">
              <img src="assets/img/images.jpeg" className="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="100" style={{height:'auto',width:'100%',borderRadius:'7px'}} />
          ...
          <div className="row gy-4">
            ...
            <div className="col-xl-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
              <div className="member">
                <img src="assets/img/images (7).jpeg" className="img-fluid" alt="" style={{height:'auto',width:'100%',borderRadius:'7px'}}/>
            ...
            <div className="col-xl-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
              <div className="member">
                <img src="assets/img/images (6).jpeg" className="img-fluid" alt="" style={{height:'auto',width:'100%',borderRadius:'7px'}}/>
